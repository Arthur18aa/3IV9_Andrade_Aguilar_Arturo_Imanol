...
class Main{
    ...
    public static void main(String[] args) throws IOException{
        ...
        int opcion, edad, tem, num, base, altura, ladoA, ladoB, radio, pelota, balon, gator, agua;
        char letra, temperatura, conversion;
        double area, perimetro, volumen, resultado, monto, primero, segundo, tercero, primer, segun; 

    do{
        System.out.println("Programa hecho por:");
        System.out.println("3IV9 Andrade Aguilar Arturo Imanol.");
        System.out.println("Elija una opcion:");
        System.out.println("1.o Aplicar un descuento.");
        System.out.println("2.o Conversion de decimales a binarios.");
        System.out.println("3.o Conversion de temperaturas.");
        ...
        switch(opcion) {
            case 1:
                ...
                if(edad > 65){
                    System.out.println("Su descuento es del 40 %. Gracias por visitarnos.");
                }
                if(edad < 21){
                    System.out.println("¿Tus padres son socios de el establecimiento? Escriba s para si o n para no.");
                        letra = entrada.next().charAt(0);
                        if(letra == 's'){
                            System.out.println("Su descuento es del 45 %. Gracias por visitarnos.");
                        }
                        else if(letra == 'n'){
                            System.out.println("Su descuento es de 25 %. Gracias por visitarnos.");
                        }
                }
                if(edad >= 21 & edad <= 65){
            ...
            case 2:
                do{
                System.out.println("Ingrese un numero entero y positivo para hacer la conversion al sistema binario.");
                num = entrada.nextInt ();
                String binario = "";
                if (num > 0){
            ...
            case 3:
                ...
                System.out.println("Escriba con base a la nomenclatura la unidad en que se  quiere convertir:");
            ...
            case 4:
                do{
                System.out.println("Escriba tres numeros y le diremos cuantos son positivos o negativos.");
