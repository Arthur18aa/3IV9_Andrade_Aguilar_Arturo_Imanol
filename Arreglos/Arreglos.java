...
public class Arreglos{
    ...
    public static void main(String[] args){
        ...
        System.out.println("¿Deseas volver al menu? Si es así escriba la letra a.");
        System.out.println("Si deseas salir, presiona cualquier otra letra.");
    ...
    public void menu(){
      ...
      int [] array = new int [10];
        ...
        Arreglos po = new Arreglos();
          ...
          System.out.print("Escriba el número del programa a realizar: ");
          System.out.println("");
      ...
      if (option<1||option>5){
        ...
        case 1:
          ...
          do{
            ...
            array = combo(array);
            po.prom_positivos(array);
            po.prom_negativos(array);

            System.out.println("Si quieres repetir el programa, escribe 'a'. Si no, escriba cualquier otra letra.");
        ...
        case 3:
          ...
          float [] array2 = new float [10];
            ...
            po.ayotzinapa(array2);
            po.up_prom(array2, promedio);
            po.yei_sad(array2);
        ...
        case 4:
          ...
          char b='B';
            ...
            po.sumando_matrix(MatrizA,MatrizB);
        ...
        public void prom_pares(int[]array){
          float p=0;
          float elementos = 0;
          for (int i=0; i<array.length;i++){
        ...
        public void dar_calif(float[] array2){
        ...
        public void ayotzinapa(float[] array2){
          float may= array2[0];
          float men= array2[0];
        ...
        public void yei_sad(float[]array2){
          int apr=0;
          int repr=0;
          for (int i=0; i<array2.length;i++){
